...
CREATE PROCEDURE SanseDW_Omega_POS_GetBarcodeMaster
   ...
   @timpStamp timestamp
AS
   SELECT a.Goods_no styleID,a.ColorID,a.Long,a.Size,a.BarCode,a.UpdateTimestamp
   ...
   ORDER  BY a.UpdateTimestamp, a.Goods_No
GO

--exec SanseDW_Omega_POS_GetBarcodeMaster 'MM',0x00000000BFFC27C6
